 ...
 */
export const SMART_MEMORY_TOOLS = [
    // EXPLICIT CORE DATA MANAGEMENT
    {
        name: "list_memory_branches",
        description: "List all memory branches with statistics. Shows branch overview with entity counts, purposes, and last updated timestamps.",
        inputSchema: {
            type: "object",
            properties: {},
        },
    },
    {
        ...
        description: "Create a new memory branch for organizing knowledge by topic or domain.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Create new entities. Automatically discovers relationships and suggests optimal branch placement.",
        inputSchema: {
            type: "object",
            properties: {
                entities: {
                ...
                branch_name: {
                    type: "string",
                    description: "Memory branch to store entities in. Leave empty for auto-suggestion based on content analysis.",
                },
                auto_create_relations: {
                    type: "boolean",
                    description: "Whether to automatically create relationships with similar entities (default: true)",
                },
            },
            required: ["entities"],
        },
    },
    {
        ...
        description: "Add new observations to existing entities. Automatically updates related entity relationships if needed.",
        inputSchema: {
            type: "object",
            properties: {
                observations: {
    ...
    },
    {
        ...
        description: "Delete entities and automatically clean up related relationships.",
        inputSchema: {
            type: "object",
            properties: {
                entity_names: {
