...
export class MemoryOptimizer {
    ...
    extractKeywords(text) {
        ...
        const technicalTerms = text.match(/\b[A-Z][a-zA-Z]*\b|\b[a-z]+[A-Z][a-zA-Z]*\b|\b[a-zA-Z]*\d+[a-zA-Z]*\b/g) || [];
        const wordCounts = {};
    ...
    extractEntities(text) {
        ...
        const technicalTerms = text.match(/\b[a-z]+[A-Z][a-zA-Z]*\b|\b[A-Z][a-z]*[A-Z][a-zA-Z]*\b|\b[a-z]+_[a-z]+\b/g) || [];
