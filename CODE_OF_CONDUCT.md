...
This MCP server has been developed with significant assistance from AI tools and has been thoroughly reviewed by human developers. We believe in transparency about our development process and want to set clear expectations for our community.
...
- Test thoroughly in realistic scenarios
...
- Don't worry about whether the issue stems from AI code—focus on the problem itself
...
- **Collaboration** with contributors who want to help make this project better

Remember: Great software is built by communities, not just code generators. Your human insight, testing, and feedback are invaluable to this project's success.
